...
class compSelect extends React.Component {
    ...
    render() {
        ...
        const catalogoToChoose = () => {
            switch(this.props.schema.title) {
                case "Carril": return "carreteraCarril"
                case "Cuerpo": return  "carreteraCuerpo"
                case "Distribuidor": return  "carreteraDistribuidor"
                // case "carreteraFlujo":
                // case "carreteraGaza":
                case "Sentido": return  "carreteraSentido"
                case "Categoría":return  "reglasCategoria"
                case "Estandar": return "reglasEstandar"
                case "Segmento": return "carreteraSegmento"
            }
        }
        getAllSegmentosForClass()
        // console.log('catalogotochoose', catalogoToChoose())
        // const storeCatalogo = state => selectn(catalogoToChoose(),  state)
        const { segmentos } = this.props
        console.log('storeCatalogo', segmentos)
        return (
            <Form.Group>
                <Form.Label>{this.props.schema.title}</Form.Label>
                    <Form.Select
                        ...
                        {this.props.schema.enum.map((elem) => {
                            return (
                                <option
                                    value={elem}
                                    key={elem}
...
//   const { getAllForClass } = carreteraSegmentoActions;
  
  export default connect(mapStateToProps,  { getAllSegmentosForClass } )(compSelect);
...
const fields = {
    select: compSelect,
    carreteraSegmento: compSelect,
    carreteraCarril: compSelect,
    carreteraCuerpo: compSelect,
    carreteraDistribuidor: compSelect,
    carreteraFlujo: compSelect,
    carreteraGaza: compSelect,
    carreteraSentido: compSelect,
    reglasCategoria: compSelect,
    reglasEstandar: compSelect,
